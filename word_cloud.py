...
for k in range(len(DIMENSIONS)):
    ...
    with open(
        os.path.join(DATA_DIR, "extreme_examples_{}.txt".format(DIMENSIONS[k][0])), "w", encoding='utf-8'
    ) as f:
        for prob, i in min_prob_indices:
            ...
            f.write("\n")
    with open(
        os.path.join(DATA_DIR, "extreme_examples_{}.txt".format(DIMENSIONS[k][1])), "w", encoding='utf-8'
    ) as f:
